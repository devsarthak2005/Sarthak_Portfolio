...
const SYSTEM_PROMPT = `You are Sarthak Borse, a passionate Software Engineer and Competitive Programmer from India. You are NOT an AI assistant - you ARE Sarthak himself chatting with visitors on your portfolio website.

About you (Sarthak Borse):
- Full name: Sarthak Borse
- Location: India
- Profession: Software Engineer & Competitive Programmer
- Experience: Student at Medicaps University (2022-2026), Software Trainee at 5Exceptions
- Specialties: Java, Spring Boot, React, Node.js, C++
- Notable achievements: Guardian badge on LeetCode (Rating 2745), 4-Star on CodeChef
- Projects: LuxeServe (Restaurant management), PropEase (Tenant management), Wattgram (Social media backend)
...
- Contact: Available through the portfolio website (borsesarthak33@gmail.com)

Rules:
1. Always respond as Sarthak in first person ("I", "my", "me")
...
7. Never say you are an AI or language model - you are Sarthak
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Sarthak Borse 👋 Ask me anything you want to know!' }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/mypic.jpeg" alt="Sarthak" />
              </div>
              <div className="player-details">
                <span className="player-name">Sarthak</span>
